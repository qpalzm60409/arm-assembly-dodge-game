...
info_nop(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_nop.\n"));
...
info_target(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_target.\n"));
...
info_points(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_points.\n"));
...
info_step(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_step.\n"));
...
info_mmu(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_mmu.\n"));
...
info_semihosting(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_semihosting.\n"));
...
info_copro(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_copro.\n"));
...
info_cycles(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_cycles.\n"));
...
info_describecopro(p_Buffer * buffer, void *stateptr)
{
    ...
    byte cpno;
    byte cpd_buffer[CP_CoProDesc_Size(MAX_CPRS)];
    struct CP_CoProDesc *cpd = (struct CP_CoProDesc *)cpd_buffer;
    int i, count;
    word status;

    IGNORE(stateptr);

    LogInfo(LOG_INFO, ( "Entered function info_describecopro.\n"));
...
info_requestcoprodesc(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_requestcoprodesc.\n"));
...
info_angelbuffersize(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_angelbuffersize.\n"));
...
info_changeableshswi(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_changeableshswi.\n"));
...
info_cantargetexecute(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_cantargetexecute.\n"));
...
info_agentendianess(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_agentendianess.\n"));
...
info_canackheartbeat(p_Buffer * buffer, void *stateptr)
{
    ...
    LogInfo(LOG_INFO, ( "Entered function info_canackheartbeat.\n"));
