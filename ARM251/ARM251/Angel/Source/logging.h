/* -*-C-*-
 *
 *    CVS $Revision: 1.4.2.1 $
 * Revising $Author: rivimey $
 *            $Date: 1998/09/22 13:46:19 $
 *
...
typedef enum _log_id
{
    ...
    LOG_SERDRV,   /* angsd: serial & serpar drivers */
    ...
    LOG_SERLASM,  /* Assembler serialiser things */
    LOG_EXCEPT,   /* Exception handling */
