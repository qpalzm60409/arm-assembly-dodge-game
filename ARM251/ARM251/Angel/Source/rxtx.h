...
/* a decoded packet */
struct data_packet {
  unsigned int    buf_len;      /* should be set by caller */
...
struct re_state {
  ...
  unsigned int           field_c;  /* chars left in current field */
...
struct te_state {
  unsigned int           field_c;  /* position in current field */
...
re_status Angel_RxEngine(unsigned char new_ch, unsigned char ovr,
                         struct data_packet *packet, struct re_state *state);
