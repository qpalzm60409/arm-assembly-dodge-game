...
/*
 * See comments in sys.c for RealSysLibraryHandler for details of
 * the args for SysLibraryHandler
 */
extern unsigned int SysLibraryHandler(unsigned int sysCode, word r1);
