...
;
; RCS $Revision: 1.6 $
; Checkin $Date: 1997/04/22 17:01:40 $
...
; We used to reorder the number somewhat before we get to work, since we
; wanted the low numbered NaNs to be the ones that are preserved across all
; precisions. So we did in fact rearrange them to consist of the bottom 11
; fraction bits followed by the 29 lying above them, followed by the 22
; fraction bits lying between them and the top fraction bit.
;   With the removal of reason codes from generated NaNs, this is no longer
; of any importance and so has been replaced with simpler code. The old code
; was:
;
...
; unused at this stage.
        ...
        ADCS    OP1mlo,OP1mlo,OP1mlo,LSL #2
