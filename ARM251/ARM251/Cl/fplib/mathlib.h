 ...
 * Checkin $Date: 1998/11/04 12:20:07 $
...
/* Don't call _e2d if ip_number may overflow in a double, or may
 * be invalid ... */
extern  double _e2d(ip_number);
/* ... use _ANSI_e2d instead, which sets errno=ERANGE in event of overflow,
 * and returns HUGE_VAL. */
extern  double _ANSI_e2d(ip_number);
